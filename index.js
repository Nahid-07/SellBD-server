...
const stripe = require("stripe")(
  "sk_test_51M663EI0d7d7hgOsq1dJvhUdwUvG0N9xucJ6cLJLKMiui8WAq248xGm5tP384UdlrARL2FqrC0oW4n3HZU7NTl4100YCGHNPvy"
);
...
async function run() {
  try {
    ...
    const categoryCollections = client
      .db("assignment-12-DB")
      .collection("categoriesOfProduct");
    ...
    // getting only admin from the user collection
    ...
    // getting all the seller from user collection
    ...
    // getting all the buyer from the collection
    ...
    // post my order api named buyer
    app.post("/buyer", async (req, res) => {
      const buyer = req.body;
      const result = await bookingCollections.insertOne(buyer);
      res.send(result);
    });
    // getting allthe buyer from the collection
